...
Proof.
  ...
  apply eqb_string_false_iff in H. rewrite H. reflexivity. Qed.
(** [] *)
...
Proof.
  ...
  - intros H. inversion H. symmetry. apply eqb_string_refl.
...
Proof.
  ...
  unfold t_update. destruct (eqb_stringP x1 x).
  - rewrite <- e. apply eqb_string_false_iff in H. rewrite H. reflexivity.
  - reflexivity.
Qed.
