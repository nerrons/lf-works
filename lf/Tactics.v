...
Proof.
  ...
  - intros m H.
    ...
    + injection H.
      ...
      injection H0.
      intros H1.
      apply IHn' in H1. (* all the struggles *)
      rewrite H1.
      reflexivity.
Qed.
...
Fixpoint forallb {X : Type} (test : X -> bool) (l : list X) : bool :=
  match l with
  | [] => true
  | h :: t => if (test h) then (andb true (forallb test t)) else false
  end.
...
Fixpoint existsb {X : Type} (test : X -> bool) (l : list X) : bool :=
  match l with
  | [] => false
  | h :: t => if (test h) then true else (orb false (existsb test t))
  end.
...
(* actually much easier than I thought it would be *)
(** [] *)
