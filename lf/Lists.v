...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  match s1 with
  | nil => true
  | x1 :: s1' => match (member x1 s2) with
                 | true => subset s1' (remove_one x1 s2)
                 | false => false
                 end
  end.
...
Theorem bag_theorem : forall (s : bag) (x : nat),
...
Proof.
  intros l1 l2. induction l1 as [| h1 t1 IH1].
...
Theorem eq_self : forall (n : nat), (n =? n) = true.
Proof.
  induction n as [| n' IH].
  - reflexivity.
